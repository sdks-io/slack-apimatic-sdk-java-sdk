...
```java
AdminAppsRequestsApi adminAppsRequestsApi = client.getAdminAppsRequestsApi();
```
...
adminAppsRequestsApi.adminAppsRequestsListAsync(token, null, null, null).thenAccept(result -> {
