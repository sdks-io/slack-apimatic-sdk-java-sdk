...
```java
AdminAppsRestrictedApi adminAppsRestrictedApi = client.getAdminAppsRestrictedApi();
```
...
adminAppsRestrictedApi.adminAppsRestrictedListAsync(token, null, null, null, null).thenAccept(result -> {
