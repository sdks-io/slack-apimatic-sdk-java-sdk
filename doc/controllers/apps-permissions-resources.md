...
```java
AppsPermissionsResourcesApi appsPermissionsResourcesApi = client.getAppsPermissionsResourcesApi();
```
...
appsPermissionsResourcesApi.appsPermissionsResourcesListAsync(token, null, null).thenAccept(result -> {
