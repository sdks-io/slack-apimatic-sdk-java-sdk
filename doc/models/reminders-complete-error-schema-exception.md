...
| `Error` | [`RemindersCompleteErrorEnum`](../../doc/models/reminders-complete-error-enum.md) | Required | - | RemindersCompleteErrorEnum getError() | setError(RemindersCompleteErrorEnum error) |
